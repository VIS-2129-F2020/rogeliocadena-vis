...
#### The dataset for Civid cases in India was acquired through data.world and originally is sourced from the Ministry of Health & Family Welfare in India
```{r}
...
## Cloropeth Map
#### This map highlights states in the country with the highest to lowest confirmed cases of Covid cases from a range of 10,0000 - 70,000 cases
```{r}
